 ...
 *
 * These helpers are autoloaded by Composer via the "files" directive and are
 * therefore available globally at runtime. They are loaded a single time by
 * Composer (via require_once), so no redeclaration guard is required.
 *
 * @category  Omega
 * @package   Application
 * @link      https://omega-mvc.github.io
