...
final class SetTest extends AbstractViewPath
{
    /**
    ...
    {
        $out = $this->getTemplator()->templates('{% set $foo=\'bar\' %}');
    ...
    {
        $out = $this->getTemplator()->templates('{% set $bar=123 %}');
    ...
    {
        $out = $this->getTemplator()->templates('{% set $arr=[12, \'34\'] %}');
